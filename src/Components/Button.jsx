...
const Button = () => {
    return (
        <div className="btn flex gap-2 mt-3">
            <div className=" bg-white  rounded-md pl-0.5 pr-0.5 text-sm pt-0.5 pb-0.5  justify-center"> <a href="/Aditya Jain Resume.docx"> <button className=" text-sm p-3 border-solid  rounded-md bg-violet-900"> Resume</button></a></div>
